...
namespace EduMVC.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(EduMVCContext context)
        {
            _context = context;
        }
        ...
        {
            var eduMVCContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
            return View(await eduMVCContext.ToListAsync());
        }
